<div class="modal fade bd-example-modal-lg" id="CreateModuleAndSubmodulesModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" data-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header w-100">
                <div class="text-center w-100" style="background: white;">
                    <label style="font-size:20px;font-weight:bold;">CREAR MODULO Y SUBMODULOS</label>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group c_form_group">
                    <label for="submodule">SUBMODULES</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="CreateModuleAndSubmodulesAddSubmoduleButton" title="Agregar submodulo" onclick="CreateModuleAndSubmodulesAddSubmodule()">
                    <i class="fas fa-plus"></i>
                </button>
