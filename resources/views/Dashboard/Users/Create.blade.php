    ...
    <section class="content-header pb-0">
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight: 600;">Crear usuario</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group c_form_group">
                                            ...
                                            <input type="text" id="phone_number" name="phone_number"
                                                ...
                                                placeholder="Número de teléfono" value="{{ old('phone_number') }}" required
                                        ...
                                        <div class="card collapsed-card">
                                            ...
                                            <div class="card-body table-responsive" style="display: none;">
                                                ...
                                                <div class="row pl-2 icheck-primary">
                                                    <input type="checkbox"
                                                        id="{{ $permission->name }}" name="permissions[]" value="{{ $permission->name }}"><label
                                                        for="{{ $permission->name }}"
                                                        class="mt-3 ml-3">{{ $permission->name }}</label>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
