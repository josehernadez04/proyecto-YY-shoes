...
class UserRemoveWarehousesRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'user_warehouse' => ['exists:model_warehouses,warehouse_id,model_id,' . $this->input('user_id') . ',model_type,' . User::class]
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'user_warehouse.exists' => 'El usuario no tiene asignada la bodega.'
        ];
    }
}
